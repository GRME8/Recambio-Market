/* ========== DATOS CALCULADORA ========== */
    ...
    const valoresBase = {
        'Galaxy S21': 200, 'Galaxy S22': 250, 'Galaxy A52': 140, 'Galaxy Note 20': 180, 'Galaxy S20 FE': 160,
        'iPhone 13': 300, 'iPhone 12': 270, 'iPhone SE': 180, 'iPhone XR': 200, 'iPhone 11': 220,
        'Redmi Note 10': 120, 'Redmi Note 11': 130, 'Mi 11 Lite': 150, 'Poco X3': 140, 'Mi 10T': 160,
        'Moto G100': 150, 'Moto G60': 120, 'Moto E7': 80, 'Moto Edge 20': 140, 'Moto G9 Power': 100,
        'P30 Pro': 170, 'Mate 20 Lite': 110, 'Y9 Prime': 90, 'Nova 5T': 130, 'P40 Lite': 140,
        'LG Velvet': 120, 'LG K52': 80, 'LG G8X': 110, 'LG Q60': 70, 'LG V50 ThinQ': 130
    };

    /* ========== UI CALCULADORA (con comprobaciones) ========== */
        ...
        if (btnCalcular) {
            btnCalcular.addEventListener('click', function () {
                ...
                if (!marca || !modelo || !estado) {
                    if (resultadoDiv) resultadoDiv.textContent = 'Por favor selecciona marca, modelo y estado.';
                } else {
                    if (resultadoDiv) resultadoDiv.textContent = 'Valor estimado de recambio: $' + baseValue.toFixed(2);
                }
            });
        }
    }
